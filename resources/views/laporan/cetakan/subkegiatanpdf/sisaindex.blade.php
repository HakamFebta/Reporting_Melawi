...
<body>
    ...
    <table style="width:98%;border-collapse: collapse;" border="0">
        <tr>
            <td style="padding-left:80%;font-size:14px">Nanga Pinoh, {{ tgl_format_indonesia(ucwords($tglttd)) }}
            </td>
        </tr>
        <tr>
            <td style="padding-left:80%;font-size:12px">{{ $tandatangan->jabatan }}</td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="padding-left:80%;font-size:14px"><u>{{ $tandatangan->nama }}</u></td>
        </tr>
        <tr>
            <td style="padding-left:80%;font-size:14px">{{ $tandatangan->pangkat }}</td>
        </tr>
        <tr>
            <td style="padding-left:80%;font-size:14px">NIP: {{ $tandatangan->nip }}</td>
        </tr>
    </table>
</body>
