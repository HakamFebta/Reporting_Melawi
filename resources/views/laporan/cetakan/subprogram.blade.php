...
<head>
    <title>Laporan Realisasi Sub Program</title>
</head>
...
<body>
    ...
    <table style="width:98%;border-collapse: collapse;font-size:medium" align="center" border="1">
        <tr>
            ...
            <td style="text-align:center; width:20%;">Nama Program</td>
            <td style="text-align:center; width:16%;">Nama Kegiatan</td>
            <td style="text-align:center;width:16%;">Nama Sub Kegiatan</td>
