...
<body>
    ...
    <table style="width:98%;border-collapse: collapse;font-size:medium" align="center" border="1">
        <tr>
            ...
            <th style="text-align:center; width:20%;">Nama Program</th>
            <th style="text-align:center; width:16%;">Nama Kegiatan</th>
            <th style="text-align:center;width:16%;">Nama Sub Kegiatan</th>
